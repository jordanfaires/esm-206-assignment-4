...
In 2018, mean lobster size (mm) for MPA sites (`r round(t_test_2018_size$estimate[1],2)`) and non-MPA sites (`r round(t_test_2012_size$estimate[2],2)`) also differed significantly (t(`r round(t_test_2018_size$parameter,2)`) = `r round(t_test_2018_size$statistic,2)`, *p* = < 0.001).
