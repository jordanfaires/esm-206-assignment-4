...
Data for California spiny lobster (Panulirus interruptus) abundance, length and location from 2012 was collected by [Santa Barbara Term Ecological Research (SBC LTER) ](https://sbclter.msi.ucsb.edu/). Abundance and size data is collected annually by divers in late summer across five survey locations. Two locations (Isla Vista and Naples) are located within Marine Protected Areas (MPAs), while three locations (Arroyo Quemado, Mohawk and Carpenteria) are not. Mean spiny lobster length (mm) for MPA and non-MPA survey locations in 2012 and 2018 were compared by two-sample t-tests. Analyses and figures were prepared using R software version 3.6.1. 
...
- At Marine Protected Area (MPA) sites (Isla Vista and Naples), the number of lobsters observed increased substantially between 2012 to 2018 (see Table 1), with populations growing by 3,787.5% over the time period. 
- The mean length of the lobsters observed at MPA sites also increased significantly between 2012 and 2018 (see Table 1.)
- While the number of lobsters observed at non-MPA sites also increased between 2012 and 2018, observed populations only grew by 181.9%. There was no statistically significanty difference in mean lobster length between 2012 and 2018 for non-MPA sites. 
